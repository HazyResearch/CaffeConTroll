...
FunnelBridge<DataType, Layout_CRDB, DataType, Layout_CRDB>::FunnelBridge(InputLayerType * const _p_input_layer,
 ...
 **/
template <typename DataType>
void FunnelBridge<DataType, Layout_CRDB, DataType, Layout_CRDB>::forward() {
  report_forward_last_transfer.reset();
 ...
 **/
template <typename DataType>
void FunnelBridge<DataType, Layout_CRDB, DataType, Layout_CRDB>::backward() {
...
template <typename DataType>
FunnelBridge<DataType, Layout_CRDB, DataType, Layout_CRDB>::~FunnelBridge() {
}

...
Connector<DataType, InputLayout, DataType, Layout_CRDB, Connector_Lowering_R1C1>::
...
template<typename DataType, LayoutType InputLayout>
void Connector<DataType, InputLayout, DataType, Layout_CRDB, Connector_Lowering_R1C1>::

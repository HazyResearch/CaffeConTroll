...
compute(const Input1CubeType * const p_input1_cube, const Input2CubeType * const p_input2_cube,
    ...
    if(KERNELCONFIG == KernelConfig_GEMM_NOTRANS_TRANS){
        N1 = 'N';
        N2 = 'T';
        M = static_cast<int>(i1R);
    ...
    if(KERNELCONFIG == KernelConfig_GEMM_TRANS_NOTRANS){
        N1 = 'T';
        N2 = 'N';

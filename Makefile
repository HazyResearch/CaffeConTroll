...
TEST_SOURCES = test_main.cpp test_MaxPooling_bridge.cpp test_softmax_bridge.cpp test_convolution_bridge.cpp test_ReLU_bridge.cpp test_dropout_bridge.cpp test_lrn_bridge.cpp src/util.cpp 

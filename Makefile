...
INCLUDE_DIRS=$(BOOST_INCLUDE) $(GTEST_INCLUDE) $(GLOG_INCLUDE) \
	     $(LMDB_INCLUDE) $(BLAS_INCLUDE) $(EXTRA_INCLUDE)
INCLUDE_STR=$(foreach d, $(INCLUDE_DIRS), -I$d)

LIB_DIRS=$(BOOST_LIB_DIR) $(GTEST_LIB_DIR) $(GLOG_LIB_DIR) \
	 $(LMDB_LIB_DIR) $(BLAS_LIB_DIR) $(EXTRA_LIB_DIR)

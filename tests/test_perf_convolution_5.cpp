...
class PerfConvolutionBridgeTest_5 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    PerfConvolutionBridgeTest_5(){
    ...
    virtual ~PerfConvolutionBridgeTest_5() { delete layer1; delete layer2; }
...
TYPED_TEST_CASE(PerfConvolutionBridgeTest_5, DataTypes);

/*
TYPED_TEST(PerfConvolutionBridgeTest_5, TestForward){
...
TYPED_TEST(PerfConvolutionBridgeTest_5, TestForwardBackward){

...
class GPUPerfConvolutionBridgeTest_1 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUPerfConvolutionBridgeTest_1(){
    ...
    virtual ~GPUPerfConvolutionBridgeTest_1() { delete layer1; delete layer2; delete ParallelizedConvolutionBridge_; }
...
TYPED_TEST_CASE(GPUPerfConvolutionBridgeTest_1, DataTypes);

/*
TYPED_TEST(GPUPerfConvolutionBridgeTest_1, TestForward){
...
TYPED_TEST(GPUPerfConvolutionBridgeTest_1, TestForwardBackward){

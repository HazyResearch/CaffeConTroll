...
class GPUPerfConvolutionBridgeTest_6 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUPerfConvolutionBridgeTest_6(){
    ...
    virtual ~GPUPerfConvolutionBridgeTest_6() { delete layer1; delete layer2; delete ParallelizedConvolutionBridge_; }
...
TYPED_TEST_CASE(GPUPerfConvolutionBridgeTest_6, DataTypes);

/*
TYPED_TEST(GPUPerfConvolutionBridgeTest_6, TestForward){
...
TYPED_TEST(GPUPerfConvolutionBridgeTest_6, TestForwardBackward){

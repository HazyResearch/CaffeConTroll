...
class GPUPerfConvolutionBridgeTest_3 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUPerfConvolutionBridgeTest_3(){
    ...
    virtual ~GPUPerfConvolutionBridgeTest_3() { delete layer1; delete layer2; delete ParallelizedConvolutionBridge_; }
...
TYPED_TEST_CASE(GPUPerfConvolutionBridgeTest_3, DataTypes);

/*
TYPED_TEST(GPUPerfConvolutionBridgeTest_3, TestForward){
...
TYPED_TEST(GPUPerfConvolutionBridgeTest_3, TestForwardBackward){

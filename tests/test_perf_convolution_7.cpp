...
class PerfConvolutionBridgeTest_7 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    PerfConvolutionBridgeTest_7(){
    ...
    virtual ~PerfConvolutionBridgeTest_7() { delete layer1; delete layer2; }
...
TYPED_TEST_CASE(PerfConvolutionBridgeTest_7, DataTypes);

/*
TYPED_TEST(PerfConvolutionBridgeTest_7, TestForward){
...
TYPED_TEST(PerfConvolutionBridgeTest_7, TestForwardBackward){

...
class GPUParallelizedConvolutionBridgeTest_4GPU : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUParallelizedConvolutionBridgeTest_4GPU(){
    ...
    virtual ~GPUParallelizedConvolutionBridgeTest_4GPU() {
		delete layer1;
		delete layer2;
...
TYPED_TEST_CASE(GPUParallelizedConvolutionBridgeTest_4GPU, DataTypes);

TYPED_TEST(GPUParallelizedConvolutionBridgeTest_4GPU, TestInitialization){
...
TYPED_TEST(GPUParallelizedConvolutionBridgeTest_4GPU, TestForward){
  typedef typename TypeParam::T T;
...
TYPED_TEST(GPUParallelizedConvolutionBridgeTest_4GPU, TestBackward){
  typedef typename TypeParam::T T;

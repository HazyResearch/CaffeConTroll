...
class PerfConvolutionBridgeTest_2 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    PerfConvolutionBridgeTest_2(){
    ...
    virtual ~PerfConvolutionBridgeTest_2() { delete layer1; delete layer2; }
...
TYPED_TEST_CASE(PerfConvolutionBridgeTest_2, DataTypes);

/*
TYPED_TEST(PerfConvolutionBridgeTest_2, TestForward){
...
TYPED_TEST(PerfConvolutionBridgeTest_2, TestForwardBackward){

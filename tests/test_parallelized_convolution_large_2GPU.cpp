...
class ParallelizedConvolutionBridgeLarge2GPUTest : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    ParallelizedConvolutionBridgeLarge2GPUTest(){
    ...
    virtual ~ParallelizedConvolutionBridgeLarge2GPUTest() { 
        delete layer1; 
        delete layer2; 
...
TYPED_TEST_CASE(ParallelizedConvolutionBridgeLarge2GPUTest, DataTypes);

TYPED_TEST(ParallelizedConvolutionBridgeLarge2GPUTest, TestInitialization){
...
TYPED_TEST(ParallelizedConvolutionBridgeLarge2GPUTest, TestForward){
  typedef typename TypeParam::T T;
...
TYPED_TEST(ParallelizedConvolutionBridgeLarge2GPUTest, TestBackward){
  typedef typename TypeParam::T T;

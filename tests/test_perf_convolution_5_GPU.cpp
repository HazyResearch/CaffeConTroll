...
class GPUPerfConvolutionBridgeTest_5 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUPerfConvolutionBridgeTest_5(){
    ...
    virtual ~GPUPerfConvolutionBridgeTest_5() { delete layer1; delete layer2; delete ParallelizedConvolutionBridge_; }
...
TYPED_TEST_CASE(GPUPerfConvolutionBridgeTest_5, DataTypes);

/*
TYPED_TEST(GPUPerfConvolutionBridgeTest_5, TestForward){
...
TYPED_TEST(GPUPerfConvolutionBridgeTest_5, TestForwardBackward){

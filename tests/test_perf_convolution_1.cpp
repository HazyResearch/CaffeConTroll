...
class PerfConvolutionBridgeTest_1 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    PerfConvolutionBridgeTest_1(){
      ...
      ParallelizedConvolutionBridge_ = new ParallelizedBridge<DataType_SFFloat,
              ...
              Layout_CRDB, DataType_SFFloat, Layout_CRDB> >(layer1,
                  layer2, &layer_param, &solver_param, 1, 1);

      ParallelizedConvolutionBridge_->needs_to_calc_backward_grad = true;
    }

    virtual ~PerfConvolutionBridgeTest_1() { delete layer1; delete layer2; }
    ...
    static const int oD = 20;
    static const int iR = 28;
    static const int iC = 28;
...
TYPED_TEST_CASE(PerfConvolutionBridgeTest_1, DataTypes);

/*
TYPED_TEST(PerfConvolutionBridgeTest_1, TestForward){
...
TYPED_TEST(PerfConvolutionBridgeTest_1, TestForwardBackward){

...
class GPULRNBridgeTest : public ::testing::Test {
  public:
    ...
    virtual ~GPULRNBridgeTest() { delete layer1; delete layer2; delete LRNBridge_; }
...
TYPED_TEST(GPULRNBridgeTest, TestBackward){
  typedef typename TypeParam::T T;

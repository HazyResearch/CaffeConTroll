...
class GPUPerfConvolutionBridgeTest_7 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUPerfConvolutionBridgeTest_7(){
    ...
    virtual ~GPUPerfConvolutionBridgeTest_7() { delete layer1; delete layer2; delete ParallelizedConvolutionBridge_; }
...
TYPED_TEST_CASE(GPUPerfConvolutionBridgeTest_7, DataTypes);

/*
TYPED_TEST(GPUPerfConvolutionBridgeTest_7, TestForward){
...
TYPED_TEST(GPUPerfConvolutionBridgeTest_7, TestForwardBackward){

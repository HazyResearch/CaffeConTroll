...
class GPUPerfConvolutionBridgeTest_paper3a_CPU_1GPU : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    GPUPerfConvolutionBridgeTest_paper3a_CPU_1GPU(){
      ...
      layer_param.set_gpu_0_batch_proportion(0.7);
    ...
    virtual ~GPUPerfConvolutionBridgeTest_paper3a_CPU_1GPU() {
		delete layer1;
		delete layer2;
...
TYPED_TEST_CASE(GPUPerfConvolutionBridgeTest_paper3a_CPU_1GPU, DataTypes);

TYPED_TEST(GPUPerfConvolutionBridgeTest_paper3a_CPU_1GPU, TestForwardBackward){
  ...
  std::cout << "Time for 10 FW, BW passes: ";

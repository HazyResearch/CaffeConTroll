...
class PerfConvolutionBridgeTest_paper3a : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    PerfConvolutionBridgeTest_paper3a(){
    ...
    virtual ~PerfConvolutionBridgeTest_paper3a() { delete layer1; delete layer2; }
...
TYPED_TEST_CASE(PerfConvolutionBridgeTest_paper3a, DataTypes);

TYPED_TEST(PerfConvolutionBridgeTest_paper3a, TestForwardBackward){

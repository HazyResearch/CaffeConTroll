...
class ParallelizedFCBridgeTestGPU : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    ParallelizedFCBridgeTestGPU(){
    ...
    virtual ~ParallelizedFCBridgeTestGPU() {
		delete layer1; 
		delete layer2;
		delete layer1c; 
		delete layer2c;
...
TYPED_TEST_CASE(ParallelizedFCBridgeTestGPU, DataTypes);

TYPED_TEST(ParallelizedFCBridgeTestGPU, TestInitialization){

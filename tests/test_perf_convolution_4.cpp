...
class PerfConvolutionBridgeTest_4 : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    PerfConvolutionBridgeTest_4(){
    ...
    virtual ~PerfConvolutionBridgeTest_4() { delete layer1; delete layer2; }
...
TYPED_TEST_CASE(PerfConvolutionBridgeTest_4, DataTypes);

/*
TYPED_TEST(PerfConvolutionBridgeTest_4, TestForward){
...
TYPED_TEST(PerfConvolutionBridgeTest_4, TestForwardBackward){

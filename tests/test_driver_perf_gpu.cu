...
__device__ FPMAP_ID fpmap_id = _fpmap_id;
...
__device__ FPMAP_DATA_READC fmap_lower = _fmap_lower;
...
TEST(DeviceDriverTest, GPU_TEST_LOWERING_DRIVER) {
	...
	driver.pmap2d_read_coalesce(&p_output, &p_data, &fpmap_id, &fmap_lower, args);

...
class ParallelizedConvolutionBridgeLargeCPUTest : public ::testing::Test {
  public:
    typedef typename TypeParam::T T;
    ParallelizedConvolutionBridgeLargeCPUTest(){
    ...
    virtual ~ParallelizedConvolutionBridgeLargeCPUTest() { delete layer1; delete layer2; delete ParallelizedConvolutionBridge_; }
...
TYPED_TEST_CASE(ParallelizedConvolutionBridgeLargeCPUTest, DataTypes);

TYPED_TEST(ParallelizedConvolutionBridgeLargeCPUTest, TestInitialization){
...
TYPED_TEST(ParallelizedConvolutionBridgeLargeCPUTest, TestForward){
  typedef typename TypeParam::T T;
...
TYPED_TEST(ParallelizedConvolutionBridgeLargeCPUTest, TestBackward){
  typedef typename TypeParam::T T;
